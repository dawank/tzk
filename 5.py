...
╚══════════════════════
"""
tjia="ubbf5fbe22865fcd64a4c4937d5b547c6"
...
║╠❂➣Nk: @
║╠❂➣Ulti @
║╠❂➣Join group: [nama group]
║╠❂➣Leave group: [nama group]
║╠❂➣Leave bot: [nama group]
║╠❂➣Leave all group
║╠❂➣Bot restart
║╠❂➣Turn off
║╚═══════════════
...
Fmid = luly.getProfile().mid
Bots=[mid,Amid,Bmid,Cmid,Dmid,Emid,Fmid]
Creator=["ubbf5fbe22865fcd64a4c4937d5b547c6"]
admin=["ubbf5fbe22865fcd64a4c4937d5b547c6"]
...
wait = {
    ...
    'timeline':True,
    "Timeline":True,
    "comment1":"Auto Like ©By : டΰட௶ ᴮᴼᵀ\nContact Me : 👉 line.me/ti/p/~dawank_lg",
    "comment2":"Auto Like ©By : டΰட௶ ᴮᴼᵀ\nContact Me : 👉 line.me/ti/p/~dawank_lg",
    "comment3":"Auto Like ©By : டΰட௶ ᴮᴼᵀ\nContact Me : 👉 line.me/ti/p/~dawank_lg",
    "comment4":"Auto Like ©By : டΰட௶ ᴮᴼᵀ\nContact Me : 👉 line.me/ti/p/~dawank_lg",
    "comment5":"Auto Like ©By : டΰட௶ ᴮᴼᵀ\nContact Me : 👉 line.me/ti/p/~dawank_lg",    
    "commentOn":True,
    "commentBlack":{},
        ...
        if op.type == 19:
          ...
          try:
            if op.param3 in Fmid: #Akun Utama Ke Kick
              ...
              luly.acceptGroupInvitationByTicket(op.param1,Ti)
              time.sleep(0.01)
...
#            contact = cl.getContact(op.param2)
        ...
        if op.type == 15:
          if wait["Sambutan"] == True:
            if op.param2 in admin:
                return
            cl.sendText(op.param1,"Good Bye, Semoga tidak ada baper diantara kita " + cl.getContact(op.param2).displayName +  "\nSee You Next Time . . . (p′︵‵。) 🤗")
        ...
        if op.type == 26:
            ...
            if msg.contentType == 13:
                if wait["wblacklist"] == True:
                   if msg.contentMetadata["mid"] not in admin and Creator:
                    ...
                    if msg.contentMetadata["mid"] in wait["blacklist"]:
                        ...
                        wait["dblacklist"] = False
                        random.choice(KAC).sendText(msg.to,"Tidak Ada dalam Black List")
                ...
                msg.contentType = 13
#                admin1 = "ubbf5fbe22865fcd64a4c4937d5b547c6"
...
#                admin3 = "u57a54b914085fea6f04c19f6fe589057"
            ...
            if msg.contentType == 13:
              if msg.from_ in Creator and Bots:
                if wait["bots"] == True:
                    ...
                    if targets == []:
                        ...
                        for target in targets:
                            try:
                                Bots.append(target)
                                cl.sendText(msg.to,"Promoted to Bots")
                                ki.sendText(msg.to,"Promoted to Bots")
                                kk.sendText(msg.to,"Promoted to Bots")
                                kc.sendText(msg.to,"Promoted to Bots")
                                kr.sendText(msg.to,"Promoted to Bots")
                                wait["bots"] = False
                                break
                            except:
                              pass
                              print "[Command]Bots add executed"
                ...
                if wait["botsr"] == True:
                    ...
                    if targets == []:
                        ...
                        for target in targets:
                            try:
                                Bots.remove(target)
                                cl.sendText(msg.to,"Demoted from Bots")
                                ki.sendText(msg.to,"Demoted from Bots")
                                kk.sendText(msg.to,"Demoted from Bots")
                                kc.sendText(msg.to,"Demoted from Bots")
                                kr.sendText(msg.to,"Demoted from Bots")
                                wait["botsr"] = False
                                break
                            except:
                              pass
                              print "[Command]Bots remove executed"
                ...
                if wait["admin"] == True:
                    ...
                    if targets == []:
                        ...
                        for target in targets:
                            try:
                                admin.append(target)
                                cl.sendText(msg.to,"Promoted to Admin")
                                ki.sendText(msg.to,"Promoted to Admin")
                                kk.sendText(msg.to,"Promoted to Admin")
                                kc.sendText(msg.to,"Promoted to Admin")
                                kr.sendText(msg.to,"Promoted to Admin")
                                wait["admin"] = False
                                break
                            except:
                              pass
                ...
                if wait["adminr"] == True:
                    ...
                    if targets == []:
                        ...
                        for target in targets:
                            try:
                                admin.remove(target)
                                cl.sendText(msg.to,"Demoted from Admin")
                                ki.sendText(msg.to,"Demoted from Admin")
                                kk.sendText(msg.to,"Demoted from Admin")
                                kc.sendText(msg.to,"Demoted from Admin")
                                kr.sendText(msg.to,"Demoted from Admin")
                                wait["adminr"] = False
                                break
                            except:
                              pass
            ...
            elif msg.text in ["Bots list","bots list","List bots","list bots","Botslist","botslist"]:
             if msg.from_ in Creator:
              if Bots == []:
                  cl.sendText(msg.to,"The Bots List Is Empty")
              else:
                  ...
                  print "[Command]Bots List executed"
		...
		cl.sendText(msg.to,"Itu Yang Buat Grup Ini")
            ...
            if msg.contentType == 13:
              ...
              if msg.from_ in Creator:
                ...
                cl.sendText(msg.to, "Hanya untuk Creator")

            elif msg.text in ["Key group","help group","Help group"]:
              if msg.from_ in admin:
                cl.sendText(msg.to,groupMessage)
              else:
                cl.sendText(msg.to, "Hanya untuk Admin")

            elif msg.text in ["Key","help","Help"]:
                cl.sendText(msg.to,helpMessage)

            elif msg.text in ["Key self","help self","Help self"]:
              if msg.from_ in Creator and admin:
                cl.sendText(msg.to,selfMessage)
              else:
                cl.sendText(msg.to, "Hanya untuk Admin dan Creator")
              ...
              if msg.from_ in Creator and admin:
                ...
                cl.sendText(msg.to, "Hanya untuk Creator dan Admin")
	    ...
	    elif "Leave bot: " in msg.text:
		ng = msg.text.replace("Leave bot: ","")
		gid = cl.getGroupIdsJoined()
		if msg.from_ in Creator:
                    for i in gid:
                        h = cl.getGroup(i).name
...
#                if msg.from_ in Creator:
		...
		if msg.from_ in Creator:
            ...
            elif msg.text in ["Steal:on"]:
              if msg.from_ in Creator and admin:
                wait["steal"] = True

            elif msg.text in ["Gift:on"]:
                wait["gift"] = True
		...
		if midd not in admin:
		    ...
		    cl.sendText(msg.to,"Admin Detected")
                ...
                midd = "ubbf5fbe22865fcd64a4c4937d5b547c6"
                random.choice(KAC).inviteIntoGroup(msg.to,[midd])

            elif msg.text in ["Welcome","welcome","Welkam","welkam","Wc","wc"]:
                gs = cl.getGroup(msg.to)
                cl.sendText(msg.to,"Hallo Jones, Selamat Datang Di "+ gs.name)
                msg.contentType = 7
		...
		if msg.from_ in Creator:
		    G = luly.getGroup(msg.to)
                    ginfo = luly.getGroup(msg.to)
                    G.preventJoinByTicket = False
                    luly.updateGroup(G)
                    invsend = 0
                    Ticket = luly.reissueGroupTicket(msg.to)
		    ...
		    luly.sendText(msg.to,"Sape lu!")

            elif msg.text in ["Sini dong","sini dong"]:
		...
		if msg.from_ in admin:
            ...
            elif msg.text in ["Jurig kadieu"]:
		if msg.from_ in admin:
                    km.leaveGroup(msg.to)
		else:
		    cl.sendText(msg.to,"Sape lu!")		    

            elif msg.text in ["Jurig kembali ke alamnya"]:
		if msg.from_ in admin:
                    G = cl.getGroup(msg.to)
                    ginfo = cl.getGroup(msg.to)
                    G.preventJoinByTicket = False
		...
		try:
		    ...
		    wait["Leave"] = False
             ...
             if msg.from_ in admin and Creator:
                cl.sendText(msg.to,"Absen heula bray!!")
                ki.sendText(msg.to,"Apa sih..!!")
                kk.sendText(msg.to,"Kangen ya sayang?")
                kc.sendText(msg.to,"Hadir")
                kr.sendText(msg.to,"Dahdir")
                cl.sendText(msg.to,"Njir si eta Ngacai..!!")
             ...
             if msg.from_ in admin and Creator:
              ...
              for i in gid:
                ...
                cl.sendText(i, "%sseconds" % (elapsed_time))
		...
		if msg.from_ in Creator:
	        ...
	        if msg.from_ in Creator:                
              ...
              if msg.from_ in Creator:
                ...
                try:
                    ...
                    cl.sendImageWithURL(msg.to, Luly)
            ...
            elif msg.text.lower() in ["sadap say hi"]:
                    beb = "Hi Sayang 😘 " +cl.getContact(msg.from_).displayName + " 􀸂􀆇starry heart􏿿"
                    if sadap == []:
                       cl.sendText(msg.to, "Tidak ada yang disadap")
                    else:
                       random.choice(sadap).sendText(msg.to,beb)
            ...
            elif "/luly" in msg.text:
		if msg.from_ in Creator:
                    string = msg.text.replace("/luly","டΰட௶ ")
            ...
            elif "/luly2" in msg.text:
		if msg.from_ in Creator:
                    string = msg.text.replace("/luly2","டΰட௶ ")
                    if len(string.decode('utf-8')) <= 5000:
            ...
            elif "/luly3" in msg.text:
		if msg.from_ in Creator:
                    string = msg.text.replace("/luly3","டΰட௶ ")
                    if len(string.decode('utf-8')) <= 5000:
            ...
            elif "/luly4" in msg.text:
		if msg.from_ in Creator:
                    string = msg.text.replace("/luly4","டΰட௶ ")
                    if len(string.decode('utf-8')) <= 5000:
...
#                cl.sendAudio(msg.to,"hasil.mp3")
            ...
            elif msg.text in ["Luly acc invite"]:
                if msg.from_ in admin:
                    gid = cl.getGroupIdsInvited()
                    _list = ""
                    for i in gid:
